...
const functionTypeOptions = ['https', 'rtdb', 'firestore', 'storage', 'auth']
...
module.exports = class extends Generator {
  ...
  prompting() {
    ...
    return this.prompt(prompts).then(props => {
      ...
      if (!functionsV1) {
        this.log(
          'You should checkout firebase-functions v1.0.0 for sweet new features!'
        )
      }
    })
  }
  ...
  writing() {
    ...
    const triggerTypeName =
      triggerType === 'http' || triggerType === 'rtdb'
